...
const data = {
  ...
  questions: {
    ...
    200:  ["This soda brand launched the “Share a _” campaign featuring people's names on bottles.", 
           ...
           "Who won the gold medal in the women's 66 kg (welterweight) category at the Paris 2024 Summer Olympics?", 
           "Q7?", 
           "Q8?"],
  ...
  answers: {
    100:  ["Disney", "Renaissance", "natural selection", "Riley", "-sensei", "El Clásico", "take me to church", "A8"],
    200:  ["Coca-Cola", "Macedonian Greek", "speed of light", "I am inevitable.", "‘to die’", "Imane Khelif / Iman Khalif", "gabriela", "A8"],
    300:  ["Microsoft", "Abraham Lincoln", "ENIAC", "Ursula", "Hasta la vista", "Soccer (football)", "mind over matter", "A8"],
    400:  ["Nokia", "Vlad the Impaler", "the Trinity test", "Password", "you only live once", "2018", "your idol", "A8"],
    500:  ["Nike", "Catherine the Great", "Ada Lovelace", "A bear", "antonym", "Uruguay", "if we had each other", "A8"],
    600:  ["Samsung", "Treaty of Versailles", "Quarks", "Donald Trump", "away from keyboard", "Alexandra Trusova", "spit in my face", "A8"],
    700:  ["Burberry", "Australia?", "Liver", "Snow White And The Seven Dwarfs", "bibliophile", " Los Angeles Lakers", "when we were young", "A8"],
    800:  ["Google", "Night Witches", "supernova", "The Plastics", "salary", "Melissa Vargas", "wolf in sheep's clothing", "A8"],
    900:  ["Papa John's", "December 31", "Solvay", "The Flying Dutchman", "cameo", "36", "tantrum", "A8"],
    1000: ["Louis Vuitton", "December 7, 1941", "Jupiter", "Gone Girl", "Work makes you free", "41", "wrong", "A8"]
  }
};

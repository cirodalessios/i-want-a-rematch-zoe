...
const data = {
  ...
  answers: {
    100:  ["Disney", "Renaissance", "natural selection", "Riley", "A5", "A6", "A7", "A8"],
    200:  ["Coca-Cola", "Macedonian Greek", "speed of light", "I am inevitable.", "A5", "A6", "A7", "A8"],
    300:  ["Microsoft", "Abraham Lincoln", "ENIAC", "Ursula", "A5", "A6", "A7", "A8"],
    400:  ["Nokia", "Vlad the Impaler", "the Trinity test", "Password", "A5", "A6", "A7", "A8"],
    500:  ["Nike", "Catherine the Great", "Ada Lovelace", "A bear", "A5", "A6", "A7", "A8"],
    600:  ["Samsung", "Treaty of Versailles", "Quarks", "Donald Trump", "A5", "A6", "A7", "A8"],
    700:  ["Burberry", "Australia?", "Liver", "Snow White And The Seven Dwarfs", "A5", "A6", "A7", "A8"],
    800:  ["Google", "Night Witches", "supernova", "The Plastics", "A5", "A6", "A7", "A8"],
    900:  ["Papa John's", "December 31", "Solvay", "The Flying Dutchman", "A5", "A6", "A7", "A8"],
    1000: ["Louis Vuitton", "December 7, 1941", "Jupiter", "Gone Girl", "A5", "A6", "A7", "A8"]
  }
};

...
const data = {
  ...
  answers: {
    100:  ["Disney", "Renaissance", "natural selection", "A4", "A5", "A6", "A7", "A8"],
    200:  ["Coca-Cola", "Macedonian Greek", "speed of light", "A4", "A5", "A6", "A7", "A8"],
    300:  ["Microsoft", "Abraham Lincoln", "ENIAC", "A4", "A5", "A6", "A7", "A8"],
    400:  ["Nokia", "Vlad the Impaler", "the Trinity test", "A4", "A5", "A6", "A7", "A8"],
    500:  ["Nike", "Catherine the Great", "Ada Lovelace", "A4", "A5", "A6", "A7", "A8"],
    600:  ["Samsung", "Treaty of Versailles", "Quarks", "A4", "A5", "A6", "A7", "A8"],
    700:  ["Burberry", "Australia?", "Liver", "A4", "A5", "A6", "A7", "A8"],
    800:  ["Google", "Night Witches", "supernova", "A4", "A5", "A6", "A7", "A8"],
    900:  ["Papa John's", "December 31", "Solvay", "A4", "A5", "A6", "A7", "A8"],
    1000: ["Louis Vuitton", "December 7, 1941", "Jupiter", "A4", "A5", "A6", "A7", "A8"]
  }
};
